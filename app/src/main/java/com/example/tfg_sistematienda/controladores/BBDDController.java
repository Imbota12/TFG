...
public class BBDDController {
    ...
    public void crearBBDD() {
        conexionBBDD.crearBaseDeDatosSiNoExiste();
    }

    public void crearTablasBBDD() {
        conexionBBDD.crearTablas();
    }

    public List<TiendaModel> obtenerListaTiendas() {
        return conexionBBDD.obtenerListaTiendas();
    }

    public boolean insertarTienda(String cif, String nombre, String direccion, String telefono) {
        return conexionBBDD.insertarTienda(cif, nombre, direccion, telefono);
    }
    ...
    public boolean insertarProducto(String codigoBarras, String nombre, String descripcion, int cantidadStock,
                                    ...
                                    String idTienda) {
        return conexionBBDD.insertarProducto(codigoBarras, nombre, descripcion, cantidadStock, precioUnidad, vecesComprado, vecesDevuelto, imagenProducto, idTienda);
    }

    public List<String> obtenerListaCodigosBarras() {
        return conexionBBDD.obtenerListaCodigosBarras();
    }

    public List<String> obtenerListaCodigosTicket() {
        return conexionBBDD.obtenerListaCodigosTicket();
    }

    public List<String> obtenerListaCIF() {
        return conexionBBDD.obtenerListaCIF();
    }

    public List<ProductoModel> obtenerListaProductos(String idTienda) {
        return conexionBBDD.obtenerListaProductos(idTienda);
    }
    ...
    public boolean modificarEmpleadoConContra(String dni, String nombreNuevo, String apellidoNuevo,
        ...
        return conexionBBDD.modificarEmpleadoConContra(dni, nombreNuevo, apellidoNuevo, correoNuevo, telefonoNuevo, nuevaContra);
    }
    ...
    public boolean modificarEmpleadoSinContra(String dni, String nombreNuevo, String apellidoNuevo,
        ...
        return conexionBBDD.modificarEmpleadoSinContra(dni, nombreNuevo, apellidoNuevo, correoNuevo, telefonoNuevo);
    }

    public UsuarioModel obtenerEmpleado(String dni) {
        return conexionBBDD.obtenerEmpleado(dni);
    }

    public boolean insertarLog(String accion, LocalDateTime fechaHora, String dniEmpleado) {
        return conexionBBDD.insertarLog(accion, fechaHora, dniEmpleado);
    }

    public String obtenerNombreTienda(String idTienda) {
        return conexionBBDD.obtenerNombreTienda(idTienda);
    }

    public Date obtenerFechaLimiteDevolucion(String idTicket) {
        return conexionBBDD.obtenerFechaLimiteDevolucion(idTicket);
    }

    public Date obtenerFechaTicket(String idTicket) {
        return conexionBBDD.obtenerFechaTicket(idTicket);
    }

    public boolean modificarTienda(String cif, String nuevoNombre, String nuevaDireccion, String nuevoTelefono) {
        return conexionBBDD.modificarTienda(cif, nuevoNombre, nuevaDireccion, nuevoTelefono);
    }

    public List<LogModel> obtenerListaLogs() {
        return conexionBBDD.obtenerListaLogs();
    }

    public List<LogModel> obtenerListaLogsPorDni(String dni) {
        return conexionBBDD.obtenerListaLogsPorDni(dni);
    }

    public List<String> obtenerDnis() {
        return conexionBBDD.obtenerDnis();
    }

    public List<LogModel> obtenerListaLogsPorFechaIgual(LocalDate fecha) {
        return conexionBBDD.obtenerListaLogsPorFechaIgual(fecha);
    }

    public List<LogModel> obtenerListaLogsPorFechaMayor(LocalDate fecha) {
        return conexionBBDD.obtenerListaLogsPorFechaMayor(fecha);
    }

    public List<LogModel> obtenerListaLogsPorFechaMenor(LocalDate fecha) {
        return conexionBBDD.obtenerListaLogsPorFechaMenor(fecha);
    }

    public List<LogModel> obtenerListaLogsPorFechaIgualconDNI(LocalDate fecha, String dni) {
        return conexionBBDD.obtenerListaLogsPorFechaIgualconDNI(fecha, dni);
    }

    public List<LogModel> obtenerListaLogsPorFechaMayorconDNI(LocalDate fecha, String dni) {
        return conexionBBDD.obtenerListaLogsPorFechaMayorconDNI(fecha, dni);
    }

    public List<LogModel> obtenerListaLogsPorFechaMenorconDNI(LocalDate fecha, String dni) {
        return conexionBBDD.obtenerListaLogsPorFechaMenorconDNI(fecha, dni);
    }

    public boolean vaciarLogs() {
        return conexionBBDD.vaciarLogs();
    }

    public boolean comprobarRegistrosTienda() {
        return conexionBBDD.comprobarRegistrosTienda();
    }

    public List<ProductoModel> obtenerProductosMasVendidos() {
        return conexionBBDD.obtenerProductosMasVendidos();
    }

    public List<ProductoModel> obtenerProductosMasDevueltos() {
        return conexionBBDD.obtenerProductosMasDevueltos();
    }

    public double obtenerSumaDevoluciones() {
        return conexionBBDD.obtenerSumaDevoluciones();
    }

    public double obtenerSumaVentas() {
        return conexionBBDD.obtenerSumaVentas();
    }
